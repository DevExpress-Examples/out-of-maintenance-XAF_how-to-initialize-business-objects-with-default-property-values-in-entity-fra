...
Namespace InitializeObjects.Win
    ...
    Public Partial Class InitializeObjectsWindowsFormsApplication
        ...
        Private Sub InitializeObjectsWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs)
        ...
        Private Sub InitializeObjectsWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
            e.Updater.Update();
            e.Handled = true;
#Else
