...
Namespace InitializeObjects.Win
    ...
    Partial Public Class InitializeObjectsWindowsFormsApplication
        ...
        Protected Overrides Sub CreateDefaultObjectSpaceProvider(ByVal args As CreateCustomObjectSpaceProviderEventArgs)
            ...
            End If
        End Sub
        Private Sub InitializeObjectsWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs) Handles MyBase.CustomizeLanguagesList
