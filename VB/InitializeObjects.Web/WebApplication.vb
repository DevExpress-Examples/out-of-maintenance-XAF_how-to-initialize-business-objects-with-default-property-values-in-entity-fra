...
Namespace InitializeObjects.Web
    ...
    Public Partial Class InitializeObjectsAspNetApplication
        ...
        Private module3 As [Module].InitializeObjectsModule

        Private module4 As [Module].Web.InitializeObjectsAspNetModule
        ...
        Private Sub InitializeObjectsAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
            e.Updater.Update();
            e.Handled = true;
#Else
...
#End If
        ...
        Private Sub InitializeComponent()
            ...
            module3 = New [Module].InitializeObjectsModule()
            module4 = New [Module].Web.InitializeObjectsAspNetModule()
            CType(Me, System.ComponentModel.ISupportInitialize).BeginInit()
            ' 
            ' InitializeObjectsAspNetApplication
            ' 
            ApplicationName = "InitializeObjects"
            CollectionsEditMode = Editors.ViewEditMode.Edit
            Modules.Add(module1)
            Modules.Add(module2)
            Modules.Add(module3)
            Modules.Add(module4)
            AddHandler DatabaseVersionMismatch, New EventHandler(Of DatabaseVersionMismatchEventArgs)(AddressOf InitializeObjectsAspNetApplication_DatabaseVersionMismatch)
